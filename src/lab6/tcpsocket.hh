...
class AllocateMemoryTimer : public Timed {
public:
    AllocateMemoryTimer(Semaphore *theSemaphore);
...
public:
    ...
    void generateBigData(udword theLength, byte *theData);

private:
    TCPSocket *mySocket;
    // Pointer to the application associated with this job.
    Semaphore *myTimerSemaphore;
